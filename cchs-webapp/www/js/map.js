...
function searchStart() {
    ...
    var room = text.toLowerCase();
    var specialRooms = ["Auditorium", "LGI", "Cafeteria", "Library", "Gym A", "Gym B", "Weight Room", "Main Office", "Counseling Office", "Nurse", "Career Center", "Flex Lab", "Pool"]; 
	var specialValues = ["1006","707","1001","1002","1003","1004","1005","1008","1009","1010","1011","103","1020"];
...
for(i = 0; i < 1; i++) {
    ...
    var hall1 = new Hallway(.4,11.5,0,6,1,["301","302","304","305","306","307","308","310","311","312"], ["r1.0", "l1.0", "l1.5", "r3.5", "l3.5", "r4.0", "l4.0", "l5.0", "r5.0", "l5.5"]);
    ...
    var hall10 = new Hallway(1.5,2.1,1,9.3,10,["120","118","116","114","113","112","110","111","108","109","107","105","103"], ["r1.0", "r2.0", "r2.5", "r3.5", "l3.5", "r4.0", "r4.5", "l4.7", "r5.0", "l5.5", "l6.0", "l7.0", "l7.5"]);
    ...
    var hall15 = new Hallway(17.6,12.2,0,10.4,15,["500","707","705","703","701","1005","1006","1013"], ["l8.0", "r5.5", "r4.5", "r4.0", "r3.5","r3.0","l9.0","l4.5"]);
    var hall16 = new Hallway(12,10,1,5.8,16,["1003"], ["l4.5"]);
    var hall17 = new Hallway(20.6,4.2,1,3.3,17,["809","808","807"], ["l0.5", "r1.0", "r2.5"]);
    var hall18 = new Hallway(22.2,4.2,0,2.7,18,["806","805","804"], ["r1.5", "r2.0", "r2.5"]);
    ...
    var hall22 = new Hallway(10.8,1.8,1,7,22,["106","104","102","1008","1009","1012"],["r3.7", "r3.7", "r6.2","r0.0","r0.5","l1.0"]);
    var hall23 = new Hallway(12.1,10.7,0,3.9,23,["401","1004", "1020"],["l3.5","r4.0", "r2.5"]);
...
function teacherLoad() {
	...
	var tNames = ["Bare","Barnhart","Battistelli","Bielecki","Boger","Bott", "Campbell", "Chandler", "Christman", "Custer", "Dissinger", "Mrs. Dresch", "Mr. Dresch", "Eckert", "Engebretson", "Fried", "Gates","Gebhard", "Gernert", "Gingrich", "Goodreau", "Grumbine", "Haines", "Hall", "Harris", "Haussener", "Heizman", "Hepler", "Hopwood", "Hostetter", "Hulme", "Hysick", "Isenberg", "ISS", "Keath", "Keddie", "Keefer", "Kohr", "Lambros", "Mrs. Lebo", "Mr. Lebo", "Leiboff", "Leonard", "Light", "Lilley", "Lukridge", "Lumsden", "Lutz", "MacMillan","Marzock", "Miller", "Muenz", "Mull", "Oplinger", "Pierce", "Plichta", "Powers", "Reed", "Reisch", "Rhen", "Rhoades", "Mr. Risser", "Rita", "Schultheis", "Schwalm", "Shank", "Sides/T.Smith", "Sinico", "J.Smith", "Mr. Snyder", "Mrs. Snyder", "Sra. Snyder", "Spohn", "Steckbeck", "Steedle", "Stettner", "Strait", "Sullivan", "Mrs. Thomas", "Mr. Thomas","Tobin", "C. Wagner", "J. Wagner", "Waranavage", "Weber", "Weitzel", "Welliver", "Wildasin", "Williams", "Zackey", "Zorrilla"];
	var tLocations = [502, 206, 205, 500, 202, 305, 102, 318, 317, 212, 116, 305, 306, 313, 214, 412, 413, 307, 118, 606, 807, 403, 608, 308, 806, 409, 322, 120, 312, 217, 701, 304, 510, 401, 512, 602, 114, 204, 107, 302, 402, 210, 417, 410, 514, 110, 508, 808, 705, 208, 405, 106, 506, 404, 104, 221, 105, 803, 211, 203, 311, 112, 408, 201, 113, 604, 703, 108, 406, 301, 415, 219, 802, 303, 534, 804, 310, 809, 207, 213, 805, 215, 209, 109, 316, 407, 610, 801, 320, 314, 111];
    ...
    if(shall == ehall || specialCase == 1) {
        ...
        for(j = 0; j < path.length; j++) {
        	if(j == 1 && path[1] == 500) {
	            ...
	            if(j == 0 && !(path[j+1] == 100 || path[j+1] == 400 || path[j+1] == 500)) {
	            ...
	            //For going down the down only stairs
	                ...
	                if(path[0] == 12 && j == 0) {
	                	x1 = (halls[11].x * 10) + 10;
	                	y1 = halls[11].y - parseFloat(halls[11].coords[sClass].substring(1));
	                }
	                x2 = (halls[11].x * 10) + 10;
	                y2 = halls[2].y;
	                canvas.globalAlpha = 1;
	            ...
	            //For going up the two permissible up stairs
	                ...
	                if(pathValue == 400) {x2 = ((halls[16].x + halls[16].length) * 10) + 10;}
	                else {x2 = (halls[16].x *10) + 10;}
	                y2 = y1;
